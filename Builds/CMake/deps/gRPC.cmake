...
if (TARGET gRPC::gpr AND NOT local_grpc)
  ...
  if (grpc_FOUND AND NOT local_grpc)
    ...
    macro (add_imported_grpc libname_)
      ...
      target_link_libraries (MUSO_libs INTERFACE "gRPC::${libname_}")
...
set (GRPC_PROTO_SRCS)
set (GRPC_PROTO_HDRS)
set (GRPC_PROTO_ROOT "${CMAKE_CURRENT_SOURCE_DIR}/src/MUSO/proto/org")
...
target_compile_options (grpc_pbufs
  ...
  PUBLIC
    ...
    >)
add_library (MUSO::grpc_pbufs ALIAS grpc_pbufs)
target_link_libraries (MUSO_libs INTERFACE MUSO::grpc_pbufs)
