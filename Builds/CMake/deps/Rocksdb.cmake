...
set_target_properties (rocksdb_lib
  PROPERTIES INTERFACE_COMPILE_DEFINITIONS MUSO_ROCKSDB_AVAILABLE=1)
...
if (NOT local_rocksdb)
  ...
  if (TARGET RocksDB::rocksdb)
    ...
    target_link_libraries (MUSO_libs INTERFACE RocksDB::rocksdb)
  else ()
...
target_link_libraries (MUSO_libs INTERFACE rocksdb_lib)
