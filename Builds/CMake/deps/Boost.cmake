...
add_library (MUSO_boost INTERFACE)
add_library (MUSO::boost ALIAS MUSO_boost)
if (is_xcode)
  target_include_directories (MUSO_boost BEFORE INTERFACE ${Boost_INCLUDE_DIRS})
  target_compile_options (MUSO_boost INTERFACE --system-header-prefix="boost/")
else ()
  target_include_directories (MUSO_boost SYSTEM BEFORE INTERFACE ${Boost_INCLUDE_DIRS})
endif()

target_link_libraries (MUSO_boost
  INTERFACE
    Boost::boost
    Boost::chrono
    Boost::container
    ...
    Boost::thread)
if (Boost_COMPILER)
  target_link_libraries (MUSO_boost INTERFACE Boost::disable_autolinking)
endif ()
if (san AND is_clang)
