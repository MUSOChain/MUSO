...
if(reporting)
    ...
    if(NOT PostgreSQL_FOUND)
        ...
        if(NOT libpq-fe_FOUND OR NOT postgres_FOUND)
            ...
            target_link_libraries(MUSO_libs INTERFACE postgres)
        else()

            message("Found system installed Postgres via find_libary")

            target_include_directories(MUSO_libs INTERFACE ${libpq-fe})
        ...
        target_include_directories(MUSO_libs INTERFACE ${PostgreSQL_INCLUDE_DIRS})

        target_link_libraries(MUSO_libs INTERFACE ${PostgreSQL_LIBRARIES})
    endif()
endif()
