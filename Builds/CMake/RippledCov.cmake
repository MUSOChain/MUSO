...
if (coverage)
  if (is_clang)
    ...
    if (coverage_core_only)
      set (extract_pattern "${CMAKE_CURRENT_SOURCE_DIR}/src/MUSO/")
    endif ()
    ...
    if (LLVM_COV AND LLVM_PROFDATA)
      add_custom_target (coverage_report
        ...
        COMMAND ${CMAKE_COMMAND} -E echo "Running MUSO tests."
        COMMAND MUSO --unittest$<$<BOOL:${coverage_test}>:=${coverage_test}> --quiet --unittest-log
        ...
        COMMAND ${LLVM_COV}
          ...
          $<TARGET_FILE:MUSO> ${extract_pattern}
  ...
  elseif (is_gcc)
    ...
    if (LCOV AND GENHTML)
      add_custom_target (coverage_report
        ...
        # run tests
        COMMAND ${CMAKE_COMMAND} -E echo "Running MUSO tests for coverage report."
        COMMAND MUSO --unittest$<$<BOOL:${coverage_test}>:=${coverage_test}> --quiet --unittest-log
