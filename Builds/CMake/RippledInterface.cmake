#[===================================================================[
   MUSO compile options/settings via an interface library
#]===================================================================]

add_library (opts INTERFACE)
add_library (MUSO::opts ALIAS opts)
target_compile_definitions (opts
  INTERFACE
    ...
    $<$<BOOL:${single_io_service_thread}>:MUSO_SINGLE_IO_SERVICE_THREAD=1>)
...
#[===================================================================[
   MUSO transitive library deps via an interface library
#]===================================================================]

add_library (MUSO_syslibs INTERFACE)
add_library (MUSO::syslibs ALIAS MUSO_syslibs)
target_link_libraries (MUSO_syslibs
  INTERFACE
    $<$<BOOL:${MSVC}>:
...
if (NOT MSVC)
  ...
  target_link_libraries (MUSO_syslibs INTERFACE Threads::Threads)
endif ()

add_library (MUSO_libs INTERFACE)
add_library (MUSO::libs ALIAS MUSO_libs)
target_link_libraries (MUSO_libs INTERFACE MUSO::syslibs)
