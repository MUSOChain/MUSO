...
var filenameProto = __dirname + "/../src/cpp/MUSO/SerializeProto.h",
  filenameTxFormatsH = __dirname + "/../src/cpp/MUSO/TransactionFormats.h",
  filenameTxFormats = __dirname + "/../src/cpp/MUSO/TransactionFormats.cpp";
...
var types = {},
  fields = {};
String(fs.readFileSync(filenameProto))
  .split("\n")
...
var ttConsts = {};
String(fs.readFileSync(filenameTxFormatsH))
  .split("\n")
  .forEach(function (line) {
...
var base = [],
  sections = [],
  current = base;
String(fs.readFileSync(filenameTxFormats))
  .split("\n")
  .forEach(function (line) {
    line = line.replace(/^\s+|\s+$/g, "").replace(/\s+/g, "");
