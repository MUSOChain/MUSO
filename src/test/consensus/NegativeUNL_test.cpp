...
#include <MUSO/app/misc/NegativeUNLVote.h>
...
class NegativeUNLgRPC_test : public beast::unit_test::suite
{
    ...
    testGRPC()
    {
        ...
        auto gRpcTest = [this](
            ...
            org::MUSOl::rpc::v1::NegativeUNL to;
            MUSO::RPC::convert(to, *negUnlObject);
            if (!to.has_flags() ||
...
BEAST_DEFINE_TESTSUITE(NegativeUNL, ledger, MUSO);
BEAST_DEFINE_TESTSUITE(NegativeUNLNoAmendment, ledger, MUSO);

BEAST_DEFINE_TESTSUITE(NegativeUNLVoteInternal, consensus, MUSO);
BEAST_DEFINE_TESTSUITE_MANUAL(NegativeUNLVoteScoreTable, consensus, MUSO);
BEAST_DEFINE_TESTSUITE_PRIO(NegativeUNLVoteGoodScore, consensus, MUSO, 1);
BEAST_DEFINE_TESTSUITE_PRIO(NegativeUNLVoteOffline, consensus, MUSO, 1);
BEAST_DEFINE_TESTSUITE_PRIO(NegativeUNLVoteMaxListed, consensus, MUSO, 1);
BEAST_DEFINE_TESTSUITE_PRIO(
    NegativeUNLVoteRetiredValidator,
    consensus,
    MUSO,
    1);
BEAST_DEFINE_TESTSUITE_PRIO(NegativeUNLVoteNewValidator, consensus, MUSO, 1);
BEAST_DEFINE_TESTSUITE(NegativeUNLVoteFilterValidations, consensus, MUSO);
BEAST_DEFINE_TESTSUITE(NegativeUNLgRPC, ledger, MUSO);
