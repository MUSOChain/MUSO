...
#include <MUSO/app/ledger/BuildLedger.h>
#include <MUSO/app/ledger/LedgerMaster.h>
#include <MUSO/app/ledger/LedgerReplay.h>
#include <MUSO/app/ledger/LedgerReplayTask.h>
#include <MUSO/app/ledger/LedgerReplayer.h>
#include <MUSO/app/ledger/impl/LedgerDeltaAcquire.h>
#include <MUSO/app/ledger/impl/LedgerReplayMsgHandler.h>
#include <MUSO/app/ledger/impl/SkipListAcquire.h>
#include <MUSO/overlay/PeerSet.h>
#include <MUSO/overlay/impl/PeerImp.h>
#include <test/jtx.h>
...
struct LedgerServer
{
    ...
    createAccounts(int newAccounts)
    {
        ...
        for (int i = 0; i < newAccounts; ++i)
        {
            ...
            env.fund(jtx::MUSO(param.initAmount), accounts.back());
        }
        env.close();
    }
...
0
    ...
    testHandshake()
    {
        ...
        auto handshake = [&](bool client, bool server, bool expecting) -> bool {
            auto request = MUSO::makeRequest(true, false, false, client);
...
BEAST_DEFINE_TESTSUITE(LedgerReplay, app, MUSO);
BEAST_DEFINE_TESTSUITE(LedgerReplayer, app, MUSO);
BEAST_DEFINE_TESTSUITE(LedgerReplayerTimeout, app, MUSO);
BEAST_DEFINE_TESTSUITE_MANUAL(LedgerReplayerLong, app, MUSO);
