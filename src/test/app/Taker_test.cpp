...
private:
    ...
    MUSO() const
    {
        static Issue const issue(MUSOCurrency(), MUSOAccount());
        return issue;
    }
...
private:
    ...
    {
        return Quality(parse_amounts(in, MUSO(), out, MUSO()));
    }
...
public:
    ...
    test_MUSO_to_iou()
    {
        testcase("MUSO Quantization: input");
    ...
    test_iou_to_MUSO()
    {
        testcase("MUSO Quantization: output");
...
BEAST_DEFINE_TESTSUITE(Taker, tx, MUSO);
