    ...
    test_convert_all_of_an_asset(FeatureBitset features)
    {
...

        {
            ...
            env(pay("alice", "bob", USD(10)),
                ...
                sendmax(MUSO(5)),
                ter(tecPATH_PARTIAL));
            env.require(balance("alice", MUSO(9999.99999)));
...

        {
            ...
            env(offer("bob", MUSO(100), USD(100)));
            env(offer("bob", MUSO(1000), USD(100)));
            env(offer("bob", MUSO(10000), USD(100)));
...

        {
            ...
            env(offer("bob", MUSO(100), USD(100)));
            env(offer("bob", MUSO(1000), USD(100)));
            env(offer("dan", MUSO(100), USD(100)));
            env(pay("alice", "carol", USD(10000)),
                paths(MUSO),
                delivermin(USD(200)),
                txflags(tfPartialPayment),
...
BEAST_DEFINE_TESTSUITE(DeliverMin, app, MUSO);
