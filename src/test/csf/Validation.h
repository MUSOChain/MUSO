...
*/
//==============================================================================
#ifndef MUSO_TEST_CSF_VALIDATION_H_INCLUDED
#define MUSO_TEST_CSF_VALIDATION_H_INCLUDED

#include <MUSO/basics/tagged_integer.h>
...
public:
    ...
    unwrap() const
    {
        // For the MUSO implementation in which RCLValidation wraps
