...
#include <MUSO/net/DatabaseDownloader.h>
...
class DatabaseDownloader_test : public beast::unit_test::suite
{
    ...
    testDownload(bool verify)
    {
        ...
        MUSO::test::detail::FileDirGuard cert{
        ...
        MUSO::test::detail::FileDirGuard const data{
    ...
    testFailures()
    {
...

        {
            ...
            {
                Downloader dl{env};
                MUSO::test::detail::FileDirGuard const datafile{
                    *this, "downloads", "data", "", false, false};
...
BEAST_DEFINE_TESTSUITE(DatabaseDownloader, net, MUSO);
}  // namespace test
}  // namespace MUSO
