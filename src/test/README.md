...
Unit tests are bundled in the `MUSO` executable and can be executed using the
...
must specify it by suite or full-name (e.g. `MUSO.app.NoMUSOCheckLimits` or
just `NoMUSOCheckLimits`).
