...
public:
    ...
    testAccountLines()
    {
        ...
        for (char c = 0; c <= ('Z' - 'A'); ++c)
        {
            ...
            env(trust(alice, gw2Currency(0), gw2, tfSetNoMUSO | tfSetFreeze));
        }
        env.close();
        ...
        }
        {
            ...
            BEAST_EXPECT(line[jss::no_MUSO].asBool() == true);
        ...
        }
        {
            ...
            BEAST_EXPECT(lineA[jss::no_MUSO_peer].asBool() == true);
    ...
    testAccountLineDelete()
    {
        ...
        //   o alice offers to buy 100 USD for 100 MUSO.
        //   o becky offers to sell 100 USD for 100 MUSO.
        ...
        Account const gw1{"gw1"};
        Account const gw2{"gw2"};
        env.fund(MUSO(10000), alice, becky, cheri, gw1, gw2);
        env.close();
        ...
        // alice offers to buy 100 EUR for 100 MUSO.
        env(offer(alice, EUR(100), MUSO(100)));
        env.close();

        // becky offers to buy 100 MUSO for 100 EUR.
        env(offer(becky, MUSO(100), EUR(100)));
        env.close();
    ...
    testAccountLines2()
    {
        ...
        Env env(*this);
        {
            ...
            BEAST_EXPECT(
                lines.isMember(jss::MUSOrpc) &&
                lines[jss::MUSOrpc] == "2.0");
        }
        {
            // account_lines with no account.
            auto const lines = env.rpc(
        ...
        auto testAccountLinesHistory = [this, &env](
            ...
            BEAST_EXPECT(
                linesSeq.isMember(jss::MUSOrpc) &&
                linesSeq[jss::MUSOrpc] == "2.0");
            ...
            BEAST_EXPECT(
                linesHash.isMember(jss::MUSOrpc) &&
                linesHash[jss::MUSOrpc] == "2.0");
            BEAST_EXPECT(
        ...
        }
        {
            ...
            BEAST_EXPECT(
                linesA.isMember(jss::MUSOrpc) &&
                linesA[jss::MUSOrpc] == "2.0");
            ...
            BEAST_EXPECT(
                linesB.isMember(jss::MUSOrpc) &&
                linesB[jss::MUSOrpc] == "2.0");
            ...
            BEAST_EXPECT(
                linesC.isMember(jss::MUSOrpc) &&
                linesC[jss::MUSOrpc] == "2.0");
            ...
            BEAST_EXPECT(
                linesD.isMember(jss::MUSOrpc) &&
                linesD[jss::MUSOrpc] == "2.0");
    ...
    testAccountLineDelete2()
    {
        ...
        //   o alice offers to buy 100 EUR for 100 MUSO.
        //   o becky offers to sell 100 EUR for 100 MUSO.
        ...
        BEAST_EXPECT(
            linesBeg.isMember(jss::MUSOrpc) &&
            linesBeg[jss::MUSOrpc] == "2.0");
        ...
        BEAST_EXPECT(
            linesEnd.isMember(jss::MUSOrpc) &&
            linesEnd[jss::MUSOrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountLinesRPC, app, MUSO);
