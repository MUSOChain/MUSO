...
public:
    ...
    testErrors()
    {
        ...
        {
            Account const gw{"G"};
            env.fund(MUSO(1000), gw);
            auto const USD = gw["USD"];
            env.trust(USD(1000), bob);
            env(pay(gw, bob, MUSO(1)));
            env(offer(bob, MUSO(100), bob["USD"](1)), txflags(tfPassive));
    ...
    testUnsteppedThenStepped()
    {
        ...
        env.fund(MUSO(1000), gw1, gw2, bob);
        ...
        env(offer(bob, MUSO(100), bob["USD"](1)), txflags(tfPassive));
        env(offer(bob, MUSO(100), USD1(1)), txflags(tfPassive));
    ...
    testObjectTypes()
    {
        ...
        }
        {
            ...
            jvEscrow[jss::Amount] = MUSO(100).value().getJson(JsonOptions::none);
        ...
        }
        {
            ...
            jvPayChan[jss::Amount] =
                MUSO(300).value().getJson(JsonOptions::none);
...
BEAST_DEFINE_TESTSUITE(AccountObjects, app, MUSO);
