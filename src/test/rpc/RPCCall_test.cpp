...
static RPCCallTestData const rpcCallTestArray[] = {
    ...
    {"json2: minimal object.",
     ...
     {
         "json2",
         R"({"jsonrpc":"2.0","MUSOrpc":"2.0","id":"A1","method":"call_1"})",
     },
     RPCCallTestData::no_exception,
     R"({
    "id" : "A1",
   ...
   "params" : [
    ...
    {"json2: too many arguments.",
     __LINE__,
     {"json2",
      R"({"jsonrpc":"2.0","MUSOrpc":"2.0","id":"A1","method":"call_this"})",
      "extra"},
     RPCCallTestData::no_exception,
     R"({
    "method" : "json2",
    ...
    {"json2: omit jsonrpc.",
     ...
     {
         "json2",
         R"({"MUSOrpc":"2.0","id":"A1","method":"call_1"})",
     },
     RPCCallTestData::no_exception,
     R"({
    "id" : "A1",
    ...
    {"json2: wrong jsonrpc version.",
     ...
     {
         "json2",
         R"({"jsonrpc":"2.1","MUSOrpc":"2.0","id":"A1","method":"call_1"})",
     },
     RPCCallTestData::no_exception,
     R"({
    "id" : "A1",
    ...
    {"json2: wrong MUSOrpc version.",
     __LINE__,
     {
         "json2",
         R"({"jsonrpc":"2.0","MUSOrpc":"2.00","id":"A1","method":"call_1"})",
     },
     RPCCallTestData::no_exception,
     R"({
    "id" : "A1",
    ...
    {"json2: omit id.",
     ...
     {
         "json2",
         R"({"jsonrpc":"2.0","MUSOrpc":"2.0","method":"call_1"})",
     },
     RPCCallTestData::no_exception,
     R"({
    "jsonrpc" : "2.0",
   ...
   "MUSOrpc" : "2.0"
    ...
    {"json2: omit method.",
     ...
     {
         "json2",
         R"({"jsonrpc":"2.0","MUSOrpc":"2.0","id":"A1"})",
     },
     RPCCallTestData::no_exception,
     R"({
    "id" : "A1",
   ...
   "MUSOrpc" : "2.0"
    ...
    {"MUSO_path_find: ledger index.",
     __LINE__,
     {"MUSO_path_find", R"({"json_argument":true})", "4294967295"},
     RPCCallTestData::no_exception,
     R"({
    "method" : "MUSO_path_find",
    "params" : [
    ...
    {"MUSO_path_find: text ledger index.",
     __LINE__,
     {"MUSO_path_find", R"({"json_argument":true})", "closed"},
     RPCCallTestData::no_exception,
     R"({
    "method" : "MUSO_path_find",
    "params" : [
    ...
    {"MUSO_path_find: too few arguments.",
     __LINE__,
     {
         "MUSO_path_find",
     },
    ...
    {"MUSO_path_find: too many arguments.",
     __LINE__,
     {"MUSO_path_find", R"({"json_argument":true})", "current", "extra"},
     RPCCallTestData::no_exception,
     R"({
    "method" : "MUSO_path_find",
    "params" : [
    ...
    {"MUSO_path_find: invalid json (note extra comma).",
     __LINE__,
     {
         "MUSO_path_find",
         R"({"json_argument":true,})",
    ...
    {"MUSO_path_find: ledger index too small.",
     __LINE__,
     {"MUSO_path_find", R"({"json_argument":true})", "-1"},
     RPCCallTestData::no_exception,
     R"({
    "method" : "MUSO_path_find",
    "params" : [
    ...
    {"MUSO_path_find: ledger index too big.",
     __LINE__,
     {"MUSO_path_find", R"({"json_argument":true})", "4294967296"},
     RPCCallTestData::no_exception,
     R"({
    "method" : "MUSO_path_find",
    "params" : [
    ...
    {"MUSO_path_find: invalid text ledger index.",
     __LINE__,
     {"MUSO_path_find", R"({"json_argument":true})", "cur"},
     RPCCallTestData::no_exception,
     R"({
    "method" : "MUSO_path_find",
    "params" : [
...
BEAST_DEFINE_TESTSUITE(RPCCall, app, MUSO);
