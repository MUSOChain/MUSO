...
class Tx_test : public beast::unit_test::suite
{
    ...
    void
    cmpAmount(
        const org::MUSOl::rpc::v1::CurrencyAmount& proto_amount,
        STAmount amount)
    {
        if (amount.native())
        {
            if (!BEAST_EXPECT(proto_amount.has_MUSO_amount()))
                return;
            BEAST_EXPECT(
                proto_amount.MUSO_amount().drops() == amount.MUSO().drops());
        }
        else
        {
            ...
            org::MUSOl::rpc::v1::IssuedCurrencyAmount issuedCurrency =
    ...
    void
    cmpPaymentTx(
        const org::MUSOl::rpc::v1::Transaction& proto,
        std::shared_ptr<STTx const> txnSt)
    {
        ...
        if (!BEAST_EXPECT(proto.has_fee()))
            return;
        BEAST_EXPECT(proto.fee().drops() == fee.MUSO().drops());
        ...
        for (auto it = pathset.begin(); it < pathset.end(); ++it)
        {
            ...
            const org::MUSOl::rpc::v1::Payment_Path& protoPath =
            ...
            {
                const org::MUSOl::rpc::v1::Payment_PathElement& protoElement =
    ...
    void
    cmpMeta(
        const org::MUSOl::rpc::v1::Meta& proto,
        std::shared_ptr<TxMeta> txMeta)
    {
        ...
        org::MUSOl::rpc::v1::TransactionResult r;
    ...
    void
    cmpDeliveredAmount(
        const org::MUSOl::rpc::v1::Meta& meta,
        const org::MUSOl::rpc::v1::Transaction& txn,
    ...
    {
    public:
        org::MUSOl::rpc::v1::GetTransactionRequest request;
        org::MUSOl::rpc::v1::GetTransactionResponse reply;
    ...
    testTxGrpc()
    {
        ...
        auto grpcTx = [&grpcPort](auto hash, auto binary) {
            ...
            client.Tx();
            return std::pair<bool, org::MUSOl::rpc::v1::GetTransactionResponse>(
        ...
        for (auto&& tx : txns)
        {
            ...
            for (bool b : {false, true})
            {
                ...
                auto grpcAccountTx = [&grpcPort](
                    ...
                    -> std::
                        pair<bool, org::MUSOl::rpc::v1::GetTransactionResponse> {
                            GrpcAccountTxClient client(grpcPort);
                            client.request.set_binary(binary);
                            client.request.mutable_account()->set_address(
                                toBase58(account));
                            client.AccountTx();
                            org::MUSOl::rpc::v1::GetTransactionResponse res;
...
BEAST_DEFINE_TESTSUITE(Tx, app, MUSO);
}  // namespace test
}  // namespace MUSO
