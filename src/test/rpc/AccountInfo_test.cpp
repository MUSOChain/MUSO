...
public:
    ...
    testSignerListsV2()
    {
        ...
        // Alice has no SignerList yet.
        {
            ...
            BEAST_EXPECT(
                info.isMember(jss::MUSOrpc) && info[jss::MUSOrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(
                info[0u].isMember(jss::MUSOrpc) &&
                info[0u][jss::MUSOrpc] == "2.0");
            ...
            BEAST_EXPECT(
                info[1u].isMember(jss::MUSOrpc) &&
                info[1u][jss::MUSOrpc] == "2.0");
    ...
    public:
        ...
        org::MUSOl::rpc::v1::GetAccountInfoResponse reply;
...
BEAST_DEFINE_TESTSUITE(AccountInfo, app, MUSO);
