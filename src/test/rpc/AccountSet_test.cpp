...
public:
    ...
    testNullAccountSet()
    {
        ...
        env.fund(MUSO(10000), noMUSO(alice));
    ...
    testBadInputs()
    {
        ...
        auto jt = fset(alice, asfDisallowMUSO);
        jt[jss::ClearFlag] = asfDisallowMUSO;
        ...
        jt = fset(alice, asfDisallowMUSO);
        jt[sfFlags.fieldName] = tfAllowMUSO;
        env(jt, ter(temINVALID_FLAG));
...
BEAST_DEFINE_TESTSUITE(AccountSet, app, MUSO);
