...
public:
    ...
    testGWB(FeatureBitset features)
    {
        ...
        if (wsc->version() == 2)
        {
            ...
            expect(jv.isMember(jss::MUSOrpc) && jv[jss::MUSOrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(GatewayBalances, app, MUSO);
