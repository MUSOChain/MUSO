...
public:
    ...
    testNonAdminMinLimit()
    {
        ...
        {
            Json::Value jvo = offer(bob, MUSO(100 + i), USD_gw(1));
    ...
    testSequential(bool asAdmin)
    {
        ...
        env(offer(bob, MUSO(100), USD_bob(1)));
        env(offer(bob, MUSO(200), USD_gw(2)));
        env(offer(bob, MUSO(30), USD_gw(6)));
...
BEAST_DEFINE_TESTSUITE(AccountOffers, app, MUSO);
