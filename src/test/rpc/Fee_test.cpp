...
class Fee_test : public beast::unit_test::suite
{
    ...
    {
    public:
        org::MUSOl::rpc::v1::GetFeeRequest request;
        org::MUSOl::rpc::v1::GetFeeResponse reply;
    ...
    std::pair<bool, org::MUSOl::rpc::v1::GetFeeResponse>
    grpcGetFee(std::string const& grpcPort)
    {
        GrpcFeeClient client(grpcPort);
        client.GetFee();
        return std::pair<bool, org::MUSOl::rpc::v1::GetFeeResponse>(
    ...
    testFeeGrpc()
    {
        ...
        // fee levels data
        org::MUSOl::rpc::v1::FeeLevels& levels = *reply.mutable_levels();
        ...
        // fee data
        org::MUSOl::rpc::v1::Fee& fee = *reply.mutable_fee();
...
BEAST_DEFINE_TESTSUITE(Fee, app, MUSO);
