...
#include <MUSO/app/misc/Manifest.h>
...
class LedgerRPC_test : public beast::unit_test::suite
{
    ...
    // '!' is not part of the MUSO alphabet.
    std::string
    ...
    testLedgerEntryEscrow()
    {
        ...
        env(escrowCreate(alice, alice, MUSO(333), env.now() + 2s));
        env.close();
        ...
        std::string escrowIndex;
        {
            ...
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
            BEAST_EXPECT(
                jrr[jss::node][jss::Amount] == MUSO(333).value().getText());
    ...
    testLedgerEntryOffer()
    {
        ...
        env(offer(alice, USD(321), MUSO(322)));
        env.close();
    ...
    testLedgerEntryPayChan()
    {
        ...
        env(payChanCreate(alice, env.master, MUSO(57), 18s, alice.pk()));
        env.close();
    ...
    void
    testLedgerEntryMUSOState()
    {
        testcase("ledger_entry Request MUSOState");
        using namespace test::jtx;
        Env env{*this};
        Account const alice{"alice"};
        Account const gw{"gateway"};
        ...
        std::string const ledgerHash{to_string(env.closed()->info().hash)};
        {
            ...
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
            jvParams[jss::MUSO_state][jss::accounts][1u] = gw.human();
            jvParams[jss::MUSO_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
            BEAST_EXPECT(
        ...
        {
            // MUSO_state is not an object.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = "MUSO_state";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
            checkErrorValue(jrr, "malformedRequest", "");
        ...
        {
            // MUSO_state.currency is missing.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
        ...
        {
            // MUSO_state accounts is not an array.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = 2;
            jvParams[jss::MUSO_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
        ...
        {
            // MUSO_state one of the accounts is missing.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
        ...
        {
            // MUSO_state more than 2 accounts.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
            jvParams[jss::MUSO_state][jss::accounts][1u] = gw.human();
            jvParams[jss::MUSO_state][jss::accounts][2u] = alice.human();
            jvParams[jss::MUSO_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
        ...
        {
            // MUSO_state account[0] is not a string.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = 44;
            jvParams[jss::MUSO_state][jss::accounts][1u] = gw.human();
            jvParams[jss::MUSO_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
        ...
        {
            // MUSO_state account[1] is not a string.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
            jvParams[jss::MUSO_state][jss::accounts][1u] = 21;
            jvParams[jss::MUSO_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
        ...
        {
            // MUSO_state account[0] == account[1].
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
            jvParams[jss::MUSO_state][jss::accounts][1u] = alice.human();
            jvParams[jss::MUSO_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
        ...
        {
            // MUSO_state malformed account[0].
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] =
        ...
        {
            // MUSO_state malformed account[1].
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
            jvParams[jss::MUSO_state][jss::accounts][1u] =
        ...
        {
            // MUSO_state malformed currency.
            Json::Value jvParams;
            jvParams[jss::MUSO_state] = Json::objectValue;
            jvParams[jss::MUSO_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::MUSO_state][jss::accounts][0u] = alice.human();
            jvParams[jss::MUSO_state][jss::accounts][1u] = gw.human();
            jvParams[jss::MUSO_state][jss::currency] = "USDollars";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc(
                "json", "ledger_entry", to_string(jvParams))[jss::result];
    ...
    testLookupLedger()
    {
        ...
        env.close();
        log << env.closed()->info().hash;
        env.fund(MUSO(10000), "jim");
        env.close();
        log << env.closed()->info().hash;
        env.fund(MUSO(10000), "jill");
    ...
    testQueue()
    {
        ...
        env(pay(alice, "george", MUSO(1000)),
            json(R"({"LastLedgerSequence":7})"),
            ter(terQUEUED));
        env(offer(alice, MUSO(50000), alice["USD"](5000)),
            seq(aliceSeq + 1),
            ter(terQUEUED));
...
BEAST_DEFINE_TESTSUITE(LedgerRPC, app, MUSO);
