...
static constexpr TxnTestData txnTestArray[] = {
    ...
    {"Cannot create MUSO to MUSO paths.",
     __LINE__,
     R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    ...
    "tx_json": {
     ...
     {{"Cannot build MUSO to MUSO paths.",
       "Cannot build MUSO to MUSO paths.",
       "Missing field 'tx_json.Sequence'.",
       "Missing field 'tx_json.Sequence'."}}},
    ...
    {"'Amount' may not be MUSO for pathfinding, but 'SendMax' may be MUSO.",
     __LINE__,
     R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
...
public:
    ...
    testTransactionRPC()
    {
        ...
        test::jtx::Env env(*this);
        env.fund(test::jtx::MUSO(100000), a, ed, g);
        env.close();
...
BEAST_DEFINE_TESTSUITE(JSONRPC, MUSO_app, MUSO);
