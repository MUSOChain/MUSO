...
class ReportingETL_test : public beast::unit_test::suite
{
    ...
    public:
        ...
        org::MUSOl::rpc::v1::GetLedgerResponse reply;
    ...
    {
    public:
        org::MUSOl::rpc::v1::GetLedgerDataRequest request;
        org::MUSOl::rpc::v1::GetLedgerDataResponse reply;
    ...
    {
    public:
        org::MUSOl::rpc::v1::GetLedgerDiffRequest request;
        org::MUSOl::rpc::v1::GetLedgerDiffResponse reply;
    ...
    {
    public:
        org::MUSOl::rpc::v1::GetLedgerEntryRequest request;
        org::MUSOl::rpc::v1::GetLedgerEntryResponse reply;
    ...
    testNeedCurrentOrClosed()
    {
        ...
        {
            org::MUSOl::rpc::v1::GetAccountInfoRequest request;
            ...
            BEAST_EXPECT(!needCurrentOrClosed(request));
            request.mutable_ledger()->set_shortcut(
                org::MUSOl::rpc::v1::LedgerSpecifier::SHORTCUT_CURRENT);
            BEAST_EXPECT(needCurrentOrClosed(request));
            request.mutable_ledger()->set_shortcut(
                org::MUSOl::rpc::v1::LedgerSpecifier::SHORTCUT_CLOSED);
            BEAST_EXPECT(needCurrentOrClosed(request));
        }
        ...
        {
            org::MUSOl::rpc::v1::GetFeeRequest feeRequest;
            ...
            org::MUSOl::rpc::v1::GetTransactionRequest txRequest;
...
BEAST_DEFINE_TESTSUITE(ReportingETL, app, MUSO);
