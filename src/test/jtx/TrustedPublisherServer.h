...
*/
//==============================================================================
#ifndef MUSO_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
#define MUSO_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
...
public:
     ...
     *        dh()      ==> dh.pem
     ...
     Angeles/O=MUSO-unit-tests/CN=example.com" # generate private cert
     ...
     Francisco/O=MUSO-unit-tests/CN=127.0.0.1" \
