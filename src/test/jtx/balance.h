...
#ifndef MUSO_TEST_JTX_BALANCE_H_INCLUDED
#define MUSO_TEST_JTX_BALANCE_H_INCLUDED
...
/** A balance matches.
    ...
    doesn't exist (no MUSO) or the trust line does not
...
public:
    balance(Account const& account, none_t)
        : none_(true), account_(account), value_(MUSO)
    {
    }
