...
#ifndef MUSO_TEST_ABSTRACTCLIENT_H_INCLUDED
#define MUSO_TEST_ABSTRACTCLIENT_H_INCLUDED
...
/* Abstract MUSO Client interface.

   This abstracts the transport layer, allowing
   commands to be submitted to a MUSO server.
*/
