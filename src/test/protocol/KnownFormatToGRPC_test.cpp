...
#include <MUSO/protocol/InnerObjectFormats.h>
#include <MUSO/protocol/LedgerFormats.h>
#include <MUSO/protocol/TxFormats.h>
...
private:
        ...
        SField const* const sField)
    {
        ...
        if (fieldDesc->type() == fieldTYPE_MESSAGE)
        {
            ...
            static const std::map<int, std::string> messageMap{
                ...
                {sfFee.fieldCode,               "MUSODropsAmount"},
    ...
    {
        // Create namespace aliases for shorter names.
        namespace grpc = org::MUSOl::rpc::v1;
        namespace pbuf = google::protobuf;
...
public:
    ...
    testLedgerObjectGRPCOneOfs()
    {
        ...
        org::MUSOl::rpc::v1::LedgerObject const ledgerObject;
    ...
    testTransactionGRPCOneOfs()
    {
        ...
        org::MUSOl::rpc::v1::Transaction const txData;
...
BEAST_DEFINE_TESTSUITE(KnownFormatToGRPC, protocol, MUSO);
