...
#include <MUSO/json/json_reader.h>     // Json::Reader
#include <MUSO/protocol/ErrorCodes.h>  // RPC::containsError
#include <MUSO/protocol/InnerObjectFormats.h>
#include <MUSO/protocol/STParsedJSON.h>  // STParsedJSONObject
#include <test/jtx.h>
...
BEAST_DEFINE_TESTSUITE(InnerObjectFormatsParsedJSON, MUSO_app, MUSO);
