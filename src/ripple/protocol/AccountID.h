...
#ifndef MUSO_PROTOCOL_ACCOUNTID_H_INCLUDED
#define MUSO_PROTOCOL_ACCOUNTID_H_INCLUDED
...
/** A special account that's used as the "issuer" for MUSO. */
AccountID const&
MUSOAccount();
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, MUSO should
...
public:
    ...
    /** Return MUSO::toBase58 for the AccountID
...
template <>
struct hash<MUSO::AccountID> : MUSO::AccountID::hasher
{
