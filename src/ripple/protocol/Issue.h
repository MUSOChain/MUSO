...
#ifndef MUSO_PROTOCOL_ISSUE_H_INCLUDED
#define MUSO_PROTOCOL_ISSUE_H_INCLUDED
...
/** Returns an asset specifier that represents MUSO. */
inline Issue const&
MUSOIssue()
{
    static Issue issue{MUSOCurrency(), MUSOAccount()};
    return issue;
}
