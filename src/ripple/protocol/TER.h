...
/*
    ...
    Copyright (c) 2012 - 2019 MUSO Labs Inc.
...
#ifndef MUSO_PROTOCOL_TER_H_INCLUDED
#define MUSO_PROTOCOL_TER_H_INCLUDED
...
// See https://MUSOl.org/transaction-results.html
//
...
enum TELcodes : TERUnderlyingType {
    ...
    // Exact numbers are used in MUSO-binary-codec:
    //     https://github.com/MUSO/MUSO-binary-codec/blob/master/src/enums/definitions.json
    // Use tokens.
...
enum TEMcodes : TERUnderlyingType {
    ...
    temBAD_PATH_LOOP,
    temBAD_REGKEY,
    temBAD_SEND_MUSO_LIMIT,
    temBAD_SEND_MUSO_MAX,
    temBAD_SEND_MUSO_NO_DIRECT,
    temBAD_SEND_MUSO_PARTIAL,
    temBAD_SEND_MUSO_PATHS,
    temBAD_SEQUENCE,
    temBAD_SIGNATURE,
    temBAD_SRC_ACCOUNT,
...
enum TERcodes : TERUnderlyingType {
    ...
    terPRE_SEQ,      // Can't pay fee, no point in forwarding, so don't
                     // burden network.
    terLAST,         // DEPRECATED.
    terNO_MUSO,    // Rippling not allowed
...
enum TECcodes : TERUnderlyingType {
    ...
    // 100 .. 159 C
    //   Claim fee only (MUSO transaction with no good paths, pay to
