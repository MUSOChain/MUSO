...
#ifndef MUSO_PROTOCOL_QUALITY_H_INCLUDED
#define MUSO_PROTOCOL_QUALITY_H_INCLUDED
...
// MUSO specific constant used for parsing qualities and other things
...
public:
    ...
    */
    ...
    ceil_in(TAmounts<In, Out> const& amount, In const& limit) const
    {
        ...
        // replacing with code specific to IOUAMount and MUSOAmount
