...
#ifndef MUSO_PROTOCOL_TXFLAGS_H_INCLUDED
#define MUSO_PROTOCOL_TXFLAGS_H_INCLUDED
...
const std::uint32_t asfDefaultMUSO = 8;
...
// Payment flags:
const std::uint32_t tfNoMUSOirect = 0x00010000;
...
const std::uint32_t tfPaymentMask =
    ~(tfUniversal | tfPartialPayment | tfLimitQuality | tfNoMUSOirect);

// TrustSet flags:
const std::uint32_t tfSetfAuth = 0x00010000;
const std::uint32_t tfSetNoMUSO = 0x00020000;
const std::uint32_t tfClearNoMUSO = 0x00040000;
const std::uint32_t tfSetFreeze = 0x00100000;
const std::uint32_t tfClearFreeze = 0x00200000;
const std::uint32_t tfTrustSetMask =
    ~(tfUniversal | tfSetfAuth | tfSetNoMUSO | tfClearNoMUSO | tfSetFreeze |
      tfClearFreeze);
