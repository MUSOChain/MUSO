...
#ifndef MUSO_PROTOCOL_LEDGERFORMATS_H_INCLUDED
#define MUSO_PROTOCOL_LEDGERFORMATS_H_INCLUDED

#include <MUSO/protocol/KnownFormats.h>
...
enum LedgerEntryType {
    ...
    */
    ...
    // Simple unidirection MUSO channel
    ltPAYCHAN = 'x',
...
enum LedgerSpecificFlags {
    ...
    lsfDisallowMUSO = 0x00080000,    // True, to disallow sending MUSO.
    lsfDisableMaster = 0x00100000,  // True, force regular key
    lsfNoFreeze = 0x00200000,       // True, cannot freeze MUSO states
    ...
    lsfLowNoMUSO = 0x00100000,
    lsfHighNoMUSO = 0x00200000,
