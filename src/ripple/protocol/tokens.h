...
#ifndef MUSO_PROTOCOL_TOKENS_H_INCLUDED
#define MUSO_PROTOCOL_TOKENS_H_INCLUDED
...
/** Encode data in Base58Check format using MUSOL alphabet

    For details on the format see
    https://MUSOl.org/base58-encodings.html#base58-encodings
...
/** Decode a token of given type encoded using Base58Check and the MUSOL alphabet
