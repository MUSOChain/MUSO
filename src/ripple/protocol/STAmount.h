...
#ifndef MUSO_PROTOCOL_STAMOUNT_H_INCLUDED
#define MUSO_PROTOCOL_STAMOUNT_H_INCLUDED

#include <MUSO/basics/IOUAmount.h>
#include <MUSO/basics/LocalValue.h>
#include <MUSO/basics/MUSOAmount.h>
#include <MUSO/protocol/Issue.h>
#include <MUSO/protocol/SField.h>
#include <MUSO/protocol/STBase.h>
...
private:
    ...
    bool mIsNative;  // A shorthand for isMUSO(mIssue).
    bool mIsNegative;
...
public:
    ...
    STAmount(MUSOAmount const& amount);
...
public:
    ...
    STAmount&
    operator=(MUSOAmount const& amount)
    {
...
// IOUAmount and MUSOAmount define toSTAmount, defining this
...
inline bool
isMUSO(STAmount const& amount)
{
    return isMUSO(amount.issue().currency);
}
