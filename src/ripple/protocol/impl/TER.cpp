...
#define MAKE_ERROR(code, desc) { code, { #code, desc } }
            ...
            std::pair<char const* const, char const* const>> const results
    {
        ...
        MAKE_ERROR(tecNO_DST,                 "Destination does not exist. Send MUSO to create it."),
        MAKE_ERROR(tecNO_DST_INSUF_MUSO,       "Destination does not exist. Too little MUSO sent to create it."),
        ...
        MAKE_ERROR(tecUNFUNDED,               "Not enough MUSO to satisfy the reserve requirement."),
        MAKE_ERROR(tecUNFUNDED_ADD,           "DEPRECATED."),
        MAKE_ERROR(tecUNFUNDED_OFFER,         "Insufficient balance to fund created offer."),
        MAKE_ERROR(tecUNFUNDED_PAYMENT,       "Insufficient MUSO balance to send."),
        ...
        MAKE_ERROR(temBAD_FEE,                "Invalid fee, negative or not MUSO."),
        ...
        MAKE_ERROR(temBAD_SEND_MUSO_LIMIT,     "Malformed: Limit quality is not allowed for MUSO to MUSO."),
        MAKE_ERROR(temBAD_SEND_MUSO_MAX,       "Malformed: Send max is not allowed for MUSO to MUSO."),
        MAKE_ERROR(temBAD_SEND_MUSO_NO_DIRECT, "Malformed: No MUSO direct is not allowed for MUSO to MUSO."),
        MAKE_ERROR(temBAD_SEND_MUSO_PARTIAL,   "Malformed: Partial payment is not allowed for MUSO to MUSO."),
        MAKE_ERROR(temBAD_SEND_MUSO_PATHS,     "Malformed: Paths are not allowed for MUSO to MUSO."),
        ...
        MAKE_ERROR(temMUSO_EMPTY,           "PathSet with no paths."),
        ...
        MAKE_ERROR(terNO_MUSO,              "Path does not permit rippling."),
