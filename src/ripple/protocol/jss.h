...
#ifndef MUSO_PROTOCOL_JSONFIELDS_H_INCLUDED
#define MUSO_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS(alternatives);           // out: PathRequest, MUSOPathFind
...
JSS(base_fee_MUSO);           // out: NetworkOPs
...
JSS(destination_account);     // in: PathRequest, MUSOPathFind, account_lines
                              // out: AccountChannels
JSS(destination_amount);      // in: PathRequest, MUSOPathFind
JSS(destination_currencies);  // in: PathRequest, MUSOPathFind
...
JSS(issuer);                // in: MUSOPathFind, Subscribe,
...
JSS(no_MUSO);                  // out: AccountLines
JSS(no_MUSO_peer);             // out: AccountLines
...
JSS(paths);                      // in: MUSOPathFind
JSS(paths_canonical);            // out: MUSOPathFind
JSS(paths_computed);             // out: PathRequest, MUSOPathFind
...
JSS(reserve_base_MUSO);      // out: NetworkOPs
JSS(reserve_inc);           // out: NetworkOPs
JSS(reserve_inc_MUSO);       // out: NetworkOPs
JSS(response);              // websocket
JSS(result);                // RPC
JSS(MUSO_lines);          // out: NetworkOPs
JSS(MUSO_state);          // in: LedgerEntr
JSS(MUSOrpc);             // MUSO RPC version
JSS(role);                  // out: Ping.cpp
JSS(rpc);
JSS(rt_accounts);  // in: Subscribe, Unsubscribe
JSS(running_duration_us);
JSS(search_depth);              // in: MUSOPathFind
...
JSS(send_max);                  // in: PathRequest, MUSOPathFind
...
JSS(source_account);            // in: PathRequest, MUSOPathFind
JSS(source_amount);             // in: PathRequest, MUSOPathFind
JSS(source_currencies);         // in: PathRequest, MUSOPathFind
