...
/*
    ...
    Copyright (c) 2012, 2020 MUSO Labs Inc.
...
#ifndef MUSO_APP_LEDGER_SKIPLISTACQUIRE_H_INCLUDED
#define MUSO_APP_LEDGER_SKIPLISTACQUIRE_H_INCLUDED

#include <MUSO/app/ledger/InboundLedger.h>
#include <MUSO/app/ledger/Ledger.h>
#include <MUSO/app/ledger/impl/TimeoutCounter.h>
...
public:
    ...
    struct SkipListData
    {
        ...
        std::vector<MUSO::uint256> const skipList;
