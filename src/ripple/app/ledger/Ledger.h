...
#ifndef MUSO_APP_LEDGER_LEDGER_H_INCLUDED
#define MUSO_APP_LEDGER_LEDGER_H_INCLUDED

#include <MUSO/basics/CountedObject.h>
#include <MUSO/beast/utility/Journal.h>
#include <MUSO/core/TimeKeeper.h>
#include <MUSO/ledger/CachedView.h>
...
public:
    ...
    /** Create the Genesis ledger.
        ...
        The account has an MUSO balance equal to the total amount
        of MUSO in the system. No more MUSO than the amount which
    ...
    */
    ...
    void
    rawDestroyMUSO(MUSOAmount const& fee) override
    {
        info_.drops -= fee;
    }
