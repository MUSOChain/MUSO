...
#ifndef MUSO_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define MUSO_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
#include <MUSO/nodestore/DatabaseRotating.h>
#include <atomic>
#include <chrono>
...
private:
    ...
    std::string const dbPrefix_ = "MUSOb";
    ...
    /// recover.
    /// See also: "recovery_wait_seconds" in MUSO-example.cfg
...
private:
    ...
    // If MUSO is not healthy, defer rotate-delete.
    ...
    // at next ledger.
    // If recoveryWaitTime_ is set, this may sleep to give MUSO
