...
#ifndef MUSO_APP_MISC_NETWORKOPS_H_INCLUDED
#define MUSO_APP_MISC_NETWORKOPS_H_INCLUDED
...
/** Provides server functionality for clients.
    ...
    MUSO / NetworkOPs. However, client software connecting to non-local
    instances of MUSO will need to be hardened to protect against hostile
