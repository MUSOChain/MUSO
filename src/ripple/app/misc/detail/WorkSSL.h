...
#ifndef MUSO_APP_MISC_DETAIL_WORKSSL_H_INCLUDED
#define MUSO_APP_MISC_DETAIL_WORKSSL_H_INCLUDED

#include <MUSO/app/misc/detail/WorkBase.h>
#include <MUSO/basics/contract.h>
#include <MUSO/core/Config.h>
#include <MUSO/net/HTTPClientSSLContext.h>
