...
#include <MUSO/basics/FileUtilities.h>
    ...
    PublicKey const& pubKey) const
{
    ...
    // MUSO should be the only process writing to this file, so
    ...
    std::size_t seenSize)
{
    ...
    // overlap.
    //
    // Theorem 8 of the Analysis of the MUSO Consensus Protocol
    // (https://arxiv.org/abs/1802.07242) says:
    //     MUSO LCP guarantees fork safety if Oi,j > nj/2 + ni − qi + ti,j
