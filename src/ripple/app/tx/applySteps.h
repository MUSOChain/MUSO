...
#ifndef MUSO_TX_APPLYSTEPS_H_INCLUDED
#define MUSO_TX_APPLYSTEPS_H_INCLUDED
...
public:
    ...
    /// Constructor for an STTx that may consume more MUSO than the fee.
    TxConsequences(STTx const& tx, MUSOAmount potentialSpend);
...
/** Return the minimum fee that an "ordinary" transaction would pay.
    ...
    @return The base fee in MUSOAmount.
*/
MUSOAmount
