...
#ifndef MUSO_APP_TX_TRANSACTOR_H_INCLUDED
#define MUSO_APP_TX_TRANSACTOR_H_INCLUDED
...
protected:
    ...
    MUSOAmount mPriorBalance;   // Balance before fees.
    MUSOAmount mSourceBalance;  // Balance after fees.
