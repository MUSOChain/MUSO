...
#ifndef MUSO_TX_IMPL_SIGNER_ENTRIES_H_INCLUDED
#define MUSO_TX_IMPL_SIGNER_ENTRIES_H_INCLUDED

#include <MUSO/app/tx/impl/Transactor.h>  // NotTEC
#include <MUSO/beast/utility/Journal.h>   // beast::Journal
#include <MUSO/protocol/STTx.h>           // STTx::maxMultiSigners
#include <MUSO/protocol/TER.h>            // temMALFORMED
#include <MUSO/protocol/UintTypes.h>      // AccountID
...
#endif  // MUSO_TX_IMPL_SIGNER_ENTRIES_H_INCLUDED
