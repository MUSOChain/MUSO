...
template class FlowOfferStream<MUSOAmount, IOUAmount>;
template class FlowOfferStream<IOUAmount, MUSOAmount>;

template class TOfferStreamBase<STAmount, STAmount>;
template class TOfferStreamBase<IOUAmount, IOUAmount>;
template class TOfferStreamBase<MUSOAmount, IOUAmount>;
template class TOfferStreamBase<IOUAmount, MUSOAmount>;
}  // namespace MUSO
