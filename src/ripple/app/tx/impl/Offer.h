...
#ifndef MUSO_APP_BOOK_OFFER_H_INCLUDED
#define MUSO_APP_BOOK_OFFER_H_INCLUDED
...
template <>
inline void
TOffer<IOUAmount, MUSOAmount>::setFieldAmounts()
{
    m_entry->setFieldAmount(sfTakerPays, toSTAmount(m_amounts.in, issIn_));
...
template <>
inline void
TOffer<MUSOAmount, IOUAmount>::setFieldAmounts()
{
