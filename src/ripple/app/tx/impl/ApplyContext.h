...
#ifndef MUSO_TX_APPLYCONTEXT_H_INCLUDED
#define MUSO_TX_APPLYCONTEXT_H_INCLUDED
...
public:
     ...
     */
    TER
    checkInvariants(TER const result, MUSOAmount const fee);
