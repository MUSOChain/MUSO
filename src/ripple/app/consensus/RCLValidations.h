...
#ifndef MUSO_APP_CONSENSUSS_VALIDATIONS_H_INCLUDED
#define MUSO_APP_CONSENSUSS_VALIDATIONS_H_INCLUDED

#include <MUSO/app/ledger/Ledger.h>
#include <MUSO/consensus/Validations.h>
...
public:
    using NodeKey = MUSO::PublicKey;
    using NodeID = MUSO::NodeID;
