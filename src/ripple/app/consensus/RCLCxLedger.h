...
#ifndef MUSO_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
#define MUSO_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
...
public:
    ...
    */
    ...
    closeAgree() const
    {
        return MUSO::getCloseAgree(ledger_->info());
    }
