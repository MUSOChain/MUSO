...
#ifndef MUSO_APP_MAIN_APPLICATION_H_INCLUDED
#define MUSO_APP_MAIN_APPLICATION_H_INCLUDED
...
#include <MUSO/shamap/FullBelowCache.h>
#include <MUSO/shamap/TreeNodeCache.h>
