...
#ifndef MUSO_CORE_GRPCSERVER_H_INCLUDED
#define MUSO_CORE_GRPCSERVER_H_INCLUDED
...
private:
    ...
    org::MUSOl::rpc::v1::MUSOLedgerAPIService::AsyncService service_;
    ...
    // org::MUSOl::rpc::v1::MUSOLedgerAPIService::AsyncService::Request[RPC NAME]
...
private:
    ...
    private:
        ...
        // another MUSO node, returns the ip of the originating client.
        ...
        // If the request was proxied through
        // another MUSO node, returns the endpoint of the originating client.
        // Empty optional if request was not proxied or there was an error
        ...
        // True if the request was proxied through another MUSO node prior
        // to arriving here
        bool
        wasForwarded();
