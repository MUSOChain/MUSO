...
#include <MUSO/app/main/GRPCServer.h>
#include <MUSO/app/reporting/P2pProxy.h>
#include <MUSO/beast/core/CurrentThreadName.h>
...
GRPCServerImpl::CallData<Request, Response>::CallData(
    org::MUSOl::rpc::v1::MUSOLedgerAPIService::AsyncService& service,
...
GRPCServerImpl::setupListeners()
{
    ...
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetFeeRequest,
            org::MUSOl::rpc::v1::GetFeeResponse>;

        addToRequests(std::make_shared<cd>(
            service_,
            *cq_,
            app_,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::AsyncService::
                RequestGetFee,
            doFeeGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::GetFee,
    ...
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetAccountInfoRequest,
            org::MUSOl::rpc::v1::GetAccountInfoResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            doAccountInfoGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::GetAccountInfo,
            RPC::NO_CONDITION,
            Resource::feeReferenceRPC,
            secureGatewayIPs_));
    }
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetTransactionRequest,
            org::MUSOl::rpc::v1::GetTransactionResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            doTxGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::GetTransaction,
    ...
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::SubmitTransactionRequest,
            org::MUSOl::rpc::v1::SubmitTransactionResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            doSubmitGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::SubmitTransaction,
            RPC::NEEDS_CURRENT_LEDGER,
    ...
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetAccountTransactionHistoryRequest,
            org::MUSOl::rpc::v1::GetAccountTransactionHistoryResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            doAccountTxGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::
    ...
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetLedgerRequest,
            org::MUSOl::rpc::v1::GetLedgerResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::AsyncService::
                RequestGetLedger,
            doLedgerGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::GetLedger,
            RPC::NO_CONDITION,
            Resource::feeMediumBurdenRPC,
            secureGatewayIPs_));
    }
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetLedgerDataRequest,
            org::MUSOl::rpc::v1::GetLedgerDataResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            doLedgerDataGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::GetLedgerData,
            RPC::NO_CONDITION,
            Resource::feeMediumBurdenRPC,
            secureGatewayIPs_));
    }
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetLedgerDiffRequest,
            org::MUSOl::rpc::v1::GetLedgerDiffResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            doLedgerDiffGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::GetLedgerDiff,
            RPC::NO_CONDITION,
            Resource::feeMediumBurdenRPC,
            secureGatewayIPs_));
    }
    {
        using cd = CallData<
            org::MUSOl::rpc::v1::GetLedgerEntryRequest,
            org::MUSOl::rpc::v1::GetLedgerEntryResponse>;
        ...
        addToRequests(std::make_shared<cd>(
            ...
            *cq_,
            ...
            doLedgerEntryGrpc,
            &org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub::GetLedgerEntry,
            RPC::NO_CONDITION,
            Resource::feeMediumBurdenRPC,
            secureGatewayIPs_));
    }
...
GRPCServer::onStart()
{
    ...
    if (running_ = impl_.start(); running_)
    {
        thread_ = std::thread([this]() {
            beast::setCurrentThreadName("MUSO : GRPCServer");
            // Start the event loop and begin handling requests
            beast::setCurrentThreadName("MUSO: grpc");
