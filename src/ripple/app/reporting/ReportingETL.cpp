...
#include <MUSO/app/reporting/DBHelpers.h>
...
ReportingETL::insertTransactions(
    std::shared_ptr<Ledger>& ledger,
    org::MUSOl::rpc::v1::GetLedgerResponse& data)
{
...
ReportingETL::loadInitialLedger(uint32_t startingSequence)
{
    ...
    std::optional<org::MUSOl::rpc::v1::GetLedgerResponse> ledgerData{
...
ReportingETL::fetchLedgerData(uint32_t idx)
{
    ...
    std::optional<org::MUSOl::rpc::v1::GetLedgerResponse> response =
...
ReportingETL::buildNextLedger(
    ...
    org::MUSOl::rpc::v1::GetLedgerResponse& rawData)
{
    JLOG(journal_.info()) << __func__ << " : "
...
ReportingETL::runETLPipeline(uint32_t startSequence)
{
    ...
    ThreadSafeQueue<std::optional<org::MUSOl::rpc::v1::GetLedgerResponse>>
    ...
    std::thread extracter{[this,
                           ...
                           &writeConflict,
                           &transformQueue]() {
        beast::setCurrentThreadName("MUSO: ReportingETL extract");
        ...
        {
            auto start = std::chrono::system_clock::now();
            std::optional<org::MUSOl::rpc::v1::GetLedgerResponse> fetchResponse{
    ...
    std::thread transformer{[this,
                             ...
                             &loadQueue,
                             &transformQueue]() {
        beast::setCurrentThreadName("MUSO: ReportingETL transform");
    ...
    std::thread loader{[this,
                        ...
                        &loadQueue,
                        &writeConflict]() {
        beast::setCurrentThreadName("MUSO: ReportingETL load");
...
ReportingETL::doWork()
{
    worker_ = std::thread([this]() {
        beast::setCurrentThreadName("MUSO: ReportingETL worker");
        if (readOnly_)
            monitorReadOnly();
        else
            monitor();
