...
#ifndef MUSO_APP_REPORTING_ETLSOURCE_H_INCLUDED
#define MUSO_APP_REPORTING_ETLSOURCE_H_INCLUDED
...
class ETLSource
{
    ...
    std::unique_ptr<org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub> stub_;
