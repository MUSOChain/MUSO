...
#include <MUSO/app/reporting/ETLSource.h>
    ...
    , timer_(ioc_)
{
    try
    {
        stub_ = org::MUSOl::rpc::v1::MUSOLedgerAPIService::NewStub(
            grpc::CreateChannel(
                beast::IP::Endpoint(
...
class AsyncCallData
{
    std::unique_ptr<org::MUSOl::rpc::v1::GetLedgerDataResponse> cur_;
    std::unique_ptr<org::MUSOl::rpc::v1::GetLedgerDataResponse> next_;

    org::MUSOl::rpc::v1::GetLedgerDataRequest request_;
...
public:
        ...
        : journal_(j)
    {
        ...
        cur_ = std::make_unique<org::MUSOl::rpc::v1::GetLedgerDataResponse>();

        next_ = std::make_unique<org::MUSOl::rpc::v1::GetLedgerDataResponse>();
    ...
    CallStatus
    process(
        std::unique_ptr<org::MUSOl::rpc::v1::MUSOLedgerAPIService::Stub>& stub,
...
std::optional<org::MUSOl::rpc::v1::GetLedgerResponse>
...
ETLSource::getP2pForwardingStub() const
{
    ...
    try
    {
        return org::MUSOl::rpc::v1::MUSOLedgerAPIService::NewStub(
            grpc::CreateChannel(
                beast::IP::Endpoint(
                    boost::asio::ip::make_address(ip_), std::stoi(grpcPort_))
                    .to_string(),
...
ETLSource::forwardToP2p(RPC::JsonContext& context) const
{
    ...
    try
    {
        ...
        // Set a decorator to change the User-Agent of the handshake
        // and to tell MUSO to charge the client IP for RPC
        // resources. See "secure_gateway" in
        // https://github.com/MUSO/MUSO/blob/develop/cfg/MUSO-example.cfg
