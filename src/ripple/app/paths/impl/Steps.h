...
#ifndef MUSO_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define MUSO_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
/**
   ...
   There are five concrete step classes:
     ...
     BookStepIX is an IOU/MUSO offer book
     BookStepXI is an MUSO/IOU offer book
     MUSOEndpointStep is the source or destination account for MUSO
...
public:
    ...
    */
    ...
    /**
       ...
       account. This is needed for checkNoMUSO.
    */
    ...
    // For MUSO endpoints, one of src or dst will be the root account
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no MUSO
        constraint
     */
