...
#ifndef MUSO_APP_PATHS_PATHREQUEST_H_INCLUDED
#define MUSO_APP_PATHS_PATHREQUEST_H_INCLUDED
...
public:
    ...
    doCreate(std::shared_ptr<MUSOLineCache> const&, Json::Value const&);
    ...
    // update jvStatus
    Json::Value
    doUpdate(std::shared_ptr<MUSOLineCache> const&, bool fast);
    InfoSub::pointer
    getSubscriber();
    bool
    hasCompletion();
...
private:
    bool
    isValid(std::shared_ptr<MUSOLineCache> const& crCache);

    std::unique_ptr<Pathfinder> const&
    getPathFinder(
        std::shared_ptr<MUSOLineCache> const&,
    ...
    */
    bool
    findPaths(std::shared_ptr<MUSOLineCache> const&, int const, Json::Value&);
