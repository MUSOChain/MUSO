...
#ifndef MUSO_BASICS_RANDOM_H_INCLUDED
#define MUSO_BASICS_RANDOM_H_INCLUDED
...
static_assert(
    ...
    "The MUSO default PRNG engine must return an unsigned integral type.");

static_assert(
    std::numeric_limits<beast::xor_shift_engine::result_type>::max() >=
        std::numeric_limits<std::uint64_t>::max(),
    "The MUSO default PRNG engine return must be at least 64 bits wide.");
#endif
...
#endif  // MUSO_BASICS_RANDOM_H_INCLUDED
