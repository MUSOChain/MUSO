...
// On MUSO shutdown, cancel and wait for the update thread
...
// This actually measures time since first use, instead of since MUSO start.
...
UptimeClock::now()
{
    ...
    // Return the number of seconds since MUSO start
