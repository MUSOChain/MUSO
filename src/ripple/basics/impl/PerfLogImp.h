...
#ifndef MUSO_BASICS_PERFLOGIMP_H
#define MUSO_BASICS_PERFLOGIMP_H
...
class PerfLogImp : public PerfLog, Stoppable
{
    ...
    Counters counters_{MUSO::RPC::getHandlerNames(), JobTypes::instance()};
...
#endif  // MUSO_BASICS_PERFLOGIMP_H
