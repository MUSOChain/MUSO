...
#ifndef MUSO_BASICS_BASE_UINT_H_INCLUDED
#define MUSO_BASICS_BASE_UINT_H_INCLUDED
...
/** Integers of any length that is a multiple of 32-bits
    ...
    @note This class stores its values internally in big-endian
          ...
          binary protocol of the MUSO and cannot be changed
...
template <std::size_t Bits, class Tag>
struct is_uniquely_represented<MUSO::base_uint<Bits, Tag>>
