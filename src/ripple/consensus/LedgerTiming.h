...
#ifndef MUSO_APP_LEDGER_LEDGERTIMING_H_INCLUDED
#define MUSO_APP_LEDGER_LEDGERTIMING_H_INCLUDED
...
/** Calculates the close time resolution for the specified ledger.
    ...
    The MUSO protocol uses binning to represent time intervals using only one
