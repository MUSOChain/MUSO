...
#ifndef MUSO_CONSENSUS_CONSENSUS_H_INCLUDED
#define MUSO_CONSENSUS_CONSENSUS_H_INCLUDED
...
#include <MUSO/consensus/ConsensusProposal.h>
#include <MUSO/consensus/ConsensusTypes.h>
#include <MUSO/consensus/DisputedTx.h>
