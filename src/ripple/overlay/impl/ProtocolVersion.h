...
#ifndef MUSO_OVERLAY_PROTOCOLVERSION_H_INCLUDED
#define MUSO_OVERLAY_PROTOCOLVERSION_H_INCLUDED
...
/** Parse a set of protocol versions.
    ...
    like valid protocol versions (i.e. RTXP/1.2 and MUSOL/2.0 and later). Any
