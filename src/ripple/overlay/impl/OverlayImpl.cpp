...
#include <MUSO/overlay/impl/ConnectAttempt.h>
#include <MUSO/overlay/impl/PeerImp.h>
#include <MUSO/overlay/predicates.h>
#include <MUSO/peerfinder/make_Manager.h>
#include <MUSO/rpc/handlers/GetCounts.h>
...
OverlayImpl::onPrepare()
{
    ...
    {
        // Pool of servers operated by MUSO Labs Inc. - https://MUSO.com
        bootstrapIps.push_back("r.MUSO.com 51235");
    ...
    // Add the ips_fixed from the MUSOfg file
...
/** The number of active peers on the network
    ...
    and are running the MUSO protocol.
*/
std::size_t
...
OverlayImpl::getServerInfo()
{
    ...
    if (server_info.isMember(jss::validated_ledger))
    {
        ...
        validated_ledger.removeMember(jss::reserve_base_MUSO);
        validated_ledger.removeMember(jss::reserve_inc_MUSO);
    }
