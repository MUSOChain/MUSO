...
#ifndef MUSO_OVERLAY_PEERIMP_H_INCLUDED
#define MUSO_OVERLAY_PEERIMP_H_INCLUDED
...
#include <MUSO/overlay/Squelch.h>
#include <MUSO/overlay/impl/OverlayImpl.h>
...
public:
    ...
    */
    ...
    /** Return the version of MUSOhat the peer is running, if reported. */
    std::string
    getVersion() const;
