...
#ifndef MUSO_OVERLAY_SLOT_H_INCLUDED
#define MUSO_OVERLAY_SLOT_H_INCLUDED
...
#include <MUSO/overlay/ReduceRelayCommon.h>
...
Slot<clock_type>::getSquelchDuration(std::size_t npeers)
{
    ...
    return seconds{MUSO::rand_int(MIN_UNSQUELCH_EXPIRE / 1s, m / 1s)};
}
...
#endif  // MUSO_OVERLAY_SLOT_H_INCLUDED
