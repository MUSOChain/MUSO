...
#ifndef MUSOOMPRESSION_H_INCLUDED
#define MUSOOMPRESSION_H_INCLUDED

#include <MUSO/basics/CompressionAlgorithms.h>
    ...
    Algorithm algorithm = Algorithm::LZ4)
{
    try
    {
        if (algorithm == Algorithm::LZ4)
            return MUSO::compression_algorithms::lz4Decompress(
    ...
    Algorithm algorithm = Algorithm::LZ4)
{
    ...
    {
        if (algorithm == Algorithm::LZ4)
            return MUSO::compression_algorithms::lz4Compress(
...
#endif  // MUSOOMPRESSION_H_INCLUDED
