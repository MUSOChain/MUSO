...
#include <MUSO/rpc/handlers/Handlers.h>
#include <MUSO/rpc/handlers/Version.h>
...
Handler const handlerArray[]{
    ...
    {"noMUSO_check", byRef(&doNoMUSOCheck), Role::USER, NO_CONDITION},
    ...
    {"peer_reservations_list",
     ...
     Role::ADMIN,
     NO_CONDITION},
    {"MUSO_path_find", byRef(&doMUSOPathFind), Role::USER, NO_CONDITION},
