...
populateFee(T& to, STObject const& from)
{
    ...
    {
        to.mutable_fee()->set_drops(from.getFieldAmount(sfFee).MUSO().drops());
    }
}
...
void
convert(org::MUSOl::rpc::v1::TransactionResult& to, TER from)
{
    if (isTecClaim(from))
    {
        to.set_result_type(
            org::MUSOl::rpc::v1::TransactionResult::RESULT_TYPE_TEC);
    }
    if (isTefFailure(from))
    {
        to.set_result_type(
            org::MUSOl::rpc::v1::TransactionResult::RESULT_TYPE_TEF);
    }
    if (isTelLocal(from))
    {
        to.set_result_type(
            org::MUSOl::rpc::v1::TransactionResult::RESULT_TYPE_TEL);
    }
    if (isTemMalformed(from))
    {
        to.set_result_type(
            org::MUSOl::rpc::v1::TransactionResult::RESULT_TYPE_TEM);
    }
    if (isTerRetry(from))
    {
        to.set_result_type(
            org::MUSOl::rpc::v1::TransactionResult::RESULT_TYPE_TER);
    }
    if (isTesSuccess(from))
    {
        to.set_result_type(
            org::MUSOl::rpc::v1::TransactionResult::RESULT_TYPE_TES);
    }
}

void
convert(org::MUSOl::rpc::v1::AccountSet& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::OfferCreate& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::OfferCancel& to, STObject const& from)
{
    populateOfferSequence(to, from);
}

void
convert(org::MUSOl::rpc::v1::AccountDelete& to, STObject const& from)
{
    populateDestination(to, from);
}

void
convert(org::MUSOl::rpc::v1::CheckCancel& to, STObject const& from)
{
    populateCheckID(to, from);
}

void
convert(org::MUSOl::rpc::v1::CheckCash& to, STObject const& from)
{
    populateCheckID(to, from);
...
void
convert(org::MUSOl::rpc::v1::CheckCreate& to, STObject const& from)
{
    populateDestination(to, from);
...
void
convert(org::MUSOl::rpc::v1::DepositPreauth& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::EscrowCancel& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::EscrowCreate& to, STObject const& from)
{
    populateAmount(to, from);
...
void
convert(org::MUSOl::rpc::v1::EscrowFinish& to, STObject const& from)
{
    populateOwner(to, from);
...
void
convert(org::MUSOl::rpc::v1::PaymentChannelClaim& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::PaymentChannelCreate& to, STObject const& from)
{
    populateAmount(to, from);
...
void
convert(org::MUSOl::rpc::v1::PaymentChannelFund& to, STObject const& from)
{
    populateChannel(to, from);
...
void
convert(org::MUSOl::rpc::v1::SetRegularKey& to, STObject const& from)
{
    populateRegularKey(to, from);
}

void
convert(org::MUSOl::rpc::v1::SignerListSet& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::TicketCreate& to, STObject const& from)
{
    populateTicketCount(to, from);
}

void
convert(org::MUSOl::rpc::v1::TrustSet& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::Payment& to, STObject const& from)
{
    populateAmount(to, from);
    ...
    if (from.isFieldPresent(sfPaths))
    {
        ...
        for (auto it = pathset.begin(); it < pathset.end(); ++it)
        {
            ...
            org::MUSOl::rpc::v1::Payment_Path* protoPath = to.add_paths();

            for (auto it2 = path.begin(); it2 != path.end(); ++it2)
            {
                org::MUSOl::rpc::v1::Payment_PathElement* protoElement =
...
void
convert(org::MUSOl::rpc::v1::AccountRoot& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::Amendments& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::Check& to, STObject const& from)
{
    populateAccount(to, from);
...
void
convert(org::MUSOl::rpc::v1::DepositPreauthObject& to, STObject const& from)
{
    populateAccount(to, from);
...
void
convert(org::MUSOl::rpc::v1::FeeSettings& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::Escrow& to, STObject const& from)
{
    populateAccount(to, from);
...
void
convert(org::MUSOl::rpc::v1::LedgerHashes& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::PayChannel& to, STObject const& from)
{
    populateAccount(to, from);
...
void
convert(org::MUSOl::rpc::v1::DirectoryNode& to, STObject const& from)
{
    populateFlags(to, from);
...
void
convert(org::MUSOl::rpc::v1::Offer& to, STObject const& from)
{
    populateAccount(to, from);
...
void
convert(org::MUSOl::rpc::v1::MUSOState& to, STObject const& from)
{
    populateBalance(to, from);
...
void
convert(org::MUSOl::rpc::v1::SignerList& to, STObject const& from)
{
    populateFlags(to, from);
...
void
convert(org::MUSOl::rpc::v1::NegativeUNL& to, STObject const& from)
{
...
void
convert(org::MUSOl::rpc::v1::TicketObject& to, STObject const& from)
{
    populateAccount(to, from);
...
void
setLedgerEntryType(
    org::MUSOl::rpc::v1::AffectedNode& proto,
    ...
    switch (lgrType)
    {
        case ltACCOUNT_ROOT:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_ACCOUNT_ROOT);
            break;
        case ltDIR_NODE:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_DIRECTORY_NODE);
            break;
        case ltMUSO_STATE:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_MUSO_STATE);
            break;
        case ltSIGNER_LIST:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_SIGNER_LIST);
            break;
        case ltOFFER:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_OFFER);
            break;
        case ltLEDGER_HASHES:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_LEDGER_HASHES);
            break;
        case ltAMENDMENTS:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_AMENDMENTS);
            break;
        case ltFEE_SETTINGS:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_FEE_SETTINGS);
            break;
        case ltESCROW:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_ESCROW);
            break;
        case ltPAYCHAN:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_PAY_CHANNEL);
            break;
        case ltCHECK:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_CHECK);
            break;
        case ltDEPOSIT_PREAUTH:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_DEPOSIT_PREAUTH);
            break;
        case ltNEGATIVE_UNL:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_NEGATIVE_UNL);
            break;
        case ltTICKET:
            proto.set_ledger_entry_type(
                org::MUSOl::rpc::v1::LEDGER_ENTRY_TYPE_TICKET);
            break;
    }
}
...
convert(T& to, STObject& from, std::uint16_t type)
{
    switch (type)
    {
        ...
        case ltDIR_NODE:
            ...
            break;
        case ltMUSO_STATE:
            RPC::convert(*to.mutable_MUSO_state(), from);
            break;
        case ltSIGNER_LIST:
...
void
convert(org::MUSOl::rpc::v1::Meta& to, std::shared_ptr<TxMeta> const& from)
{
    ...
    {
        STObject& obj = *it;
        org::MUSOl::rpc::v1::AffectedNode* node = to.add_affected_nodes();
    ...
    std::vector<TxQ::TxDetails> const& from)
{
    if (!from.empty())
    {
        ...
        MUSOAmount totalSpend(0);

        for (auto const& tx : from)
        {
            org::MUSOl::rpc::v1::QueuedTransaction& qt = *to.add_transactions();
...
void
convert(
    org::MUSOl::rpc::v1::Transaction& to,
