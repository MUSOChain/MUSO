...
#ifndef MUSO_RPC_TUNING_H_INCLUDED
#define MUSO_RPC_TUNING_H_INCLUDED
...
/** Limits for the no_MUSO_check command. */
static LimitRange constexpr noMUSOCheck = {10, 300, 400};
