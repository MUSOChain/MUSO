...
#include <MUSO/basics/ToString.h>
...
populateProtoResponse(
    ...
    TxArgs const& args,
    RPC::GRPCContext<org::MUSOl::rpc::v1::GetTransactionRequest> const& context)
{
    org::MUSOl::rpc::v1::GetTransactionResponse response;
...
doTxGrpc(RPC::GRPCContext<org::MUSOl::rpc::v1::GetTransactionRequest>& context)
{
    ...
    // input
    org::MUSOl::rpc::v1::GetTransactionRequest& request = context.params;
