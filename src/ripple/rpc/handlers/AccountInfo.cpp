...
{
    // Return values
    org::MUSOl::rpc::v1::GetAccountInfoResponse result;
    grpc::Status status = grpc::Status::OK;

    // input
    org::MUSOl::rpc::v1::GetAccountInfoRequest& params = context.params;
    ...
    if (sleAccepted)
    {
        ...
        if (params.signer_lists())
        {
            ...
            if (sleSigners)
            {
                org::MUSOl::rpc::v1::SignerList& signerListProto =
        ...
        if (params.queue())
        {
            ...
            std::vector<TxQ::TxDetails> const txs =
                context.app.getTxQ().getAccountTxs(accountID, *ledger);
            org::MUSOl::rpc::v1::QueueData& queueData =
