...
parseLedgerArgs(
    org::MUSOl::rpc::v1::GetAccountTransactionHistoryRequest const& params)
{
    grpc::Status status;
    ...
    else if (params.has_ledger_specifier())
    {
        ...
        {
            using LedgerSpecifier = org::MUSOl::rpc::v1::LedgerSpecifier;
...
populateProtoResponse(
    ...
    AccountTxArgs const& args,
    RPC::GRPCContext<
        org::MUSOl::rpc::v1::GetAccountTransactionHistoryRequest> const& context)
{
    org::MUSOl::rpc::v1::GetAccountTransactionHistoryResponse response;
