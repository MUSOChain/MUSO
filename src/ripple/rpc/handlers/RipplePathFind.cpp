...
Json::Value
doMUSOPathFind(RPC::JsonContext& context)
{
        ...
        !context.params.isMember(jss::ledger_hash))
    {
        ...
        //
        // 1. We're running doMUSOPathFind() due to a call to
        //    MUSO_path_find.  doMUSOPathFind() is currently running
        //    inside of a JobQueue::Coro using a JobQueue thread.
        //
        // 2. doMUSOPathFind's call to makeLegacyPathRequest() enqueues the
        ...
        // MUSO source code) shutting down the application.  The code to
