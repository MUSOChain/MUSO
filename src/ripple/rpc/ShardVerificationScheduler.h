...
#ifndef MUSO_RPC_SHARDVERIFICATIONSCHEDULER_H_INCLUDED
#define MUSO_RPC_SHARDVERIFICATIONSCHEDULER_H_INCLUDED
...
#endif  // MUSO_RPC_SHARDVERIFICATIONSCHEDULER_H_INCLUDED
