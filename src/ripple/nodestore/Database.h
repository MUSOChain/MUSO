...
#ifndef MUSO_NODESTORE_DATABASE_H_INCLUDED
#define MUSO_NODESTORE_DATABASE_H_INCLUDED

#include <MUSO/core/Stoppable.h>
#include <MUSO/nodestore/Backend.h>
#include <MUSO/nodestore/NodeObject.h>
#include <MUSO/nodestore/Scheduler.h>
...
private:
    ...
    // The default is 32570 to match the MUSO network's earliest
