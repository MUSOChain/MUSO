...
#ifndef MUSO_LEDGER_APPLYSTATETABLE_H_INCLUDED
#define MUSO_LEDGER_APPLYSTATETABLE_H_INCLUDED
...
public:
    ...
    void
    destroyMUSO(MUSOAmount const& fee);
