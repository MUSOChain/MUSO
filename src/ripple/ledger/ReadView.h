...
#ifndef MUSO_LEDGER_READVIEW_H_INCLUDED
#define MUSO_LEDGER_READVIEW_H_INCLUDED
...
#include <MUSO/ledger/detail/ReadViewFwdRange.h>
...
struct Fees
{
    MUSOAmount base{0};       // Reference tx cost (drops)
    FeeUnit32 units{0};      // Reference fee units
    MUSOAmount reserve{0};    // Reserve base (drops)
    MUSOAmount increment{0};  // Reserve increment (drops)
...
#include <MUSO/ledger/detail/ReadViewFwdRange.ipp>
