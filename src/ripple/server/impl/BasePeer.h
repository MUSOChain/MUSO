...
#ifndef MUSO_SERVER_BASEPEER_H_INCLUDED
#define MUSO_SERVER_BASEPEER_H_INCLUDED

#include <MUSO/beast/utility/WrappedSink.h>
#include <MUSO/server/Port.h>
#include <MUSO/server/impl/LowestLayer.h>
#include <MUSO/server/impl/io_list.h>
...
BasePeer<Handler, Impl>::close()
{
    ...
    error_code ec;
    MUSO::get_lowest_layer(impl().ws_).socket().close(ec);
}
