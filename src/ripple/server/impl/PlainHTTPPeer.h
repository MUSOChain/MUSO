...
#ifndef MUSO_SERVER_PLAINHTTPPEER_H_INCLUDED
#define MUSO_SERVER_PLAINHTTPPEER_H_INCLUDED

#include <MUSO/beast/rfc2616.h>
#include <MUSO/server/impl/BaseHTTPPeer.h>
#include <MUSO/server/impl/PlainWSPeer.h>
