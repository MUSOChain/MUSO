...
#ifndef MUSO_NET_DATABASEDOWNLOADER_H
#define MUSO_NET_DATABASEDOWNLOADER_H

#include <MUSO/net/DatabaseBody.h>
#include <MUSO/net/HTTPDownloader.h>
...
#endif  // MUSO_NET_DATABASEDOWNLOADER_H
